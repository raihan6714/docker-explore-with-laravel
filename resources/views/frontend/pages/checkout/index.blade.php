...
@section('content')
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-sm-6">
                        <div class="title-content">
                            <h1 class="medium-black fw-600">Checkout</h1>
                        </div>
                    </div>
    ...
    <div class="checkout-page">
        ...
        <div class="customer-container pt-40 mb-48">
            <div class="container-fluid-2">
                <div class="customer-wrapper">
                    <div class="title-box bg-lightest-gray">
                        <h6 class="dark-gray fw-700">Returning Customer? <a href="javascript:;"
                                                                            class="color-sec signin-button">Click here to login</a></h6>
                        <div class="sign-form mt-24">
                            <p class="mb-16">If you’ve shopped with us before, enter your information below. New customers, please continue to the Billing section.</p>
                            <form action="https://uiparadox.co.uk/public/templates/pet-haven/tracking.html" method="post">
                                <div class="row row-gap-3">
                                    <div class="col-lg-6">
                                        <div class="input-block">
                                            <input type="text" name="name" id="firstname" class="form-control form-control-2 bg-white"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="input-block">
                                            <input type="password" name="password" id="passWord"
                                                   class="form-control form-control-2 bg-white" required placeholder="Password">
            ...
            <div class="container-fluid-2">
                <form method="post" class="checkout-form">
                    <div class="row row-gap-4">
                        <div class="col-xl-8">
                            <div class="billing-wrapper p-24 bg-lightest-gray br-10 mb-16">
                                <div class="title-row title-row-2 mb-24">
                                    <h5 class="fw-700 medium-black">Billing Details</h5>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="input-block mb-16">
                                            <input type="text" name="name" id="name"
                                                   class="form-control form-control-2 bg-white" required placeholder="First Name">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-block mb-16">
                                            <input type="text" name="lname" id="lastName"
                                                   class="form-control form-control-2 bg-white" required placeholder="Last Name">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20"
                                                 fill="none">
                                                <path
                                                    d="M10.5 0C7.59223 0 5.22656 2.36566 5.22656 5.27344C5.22656 8.18121 7.59223 10.5469 10.5 10.5469C13.4078 10.5469 15.7734 8.18121 15.7734 5.27344C15.7734 2.36566 13.4078 0 10.5 0ZM10.5 9.375C8.2384 9.375 6.39844 7.53504 6.39844 5.27344C6.39844 3.01184 8.2384 1.17188 10.5 1.17188C12.7616 1.17188 14.6016 3.01184 14.6016 5.27344C14.6016 7.53504 12.7616 9.375 10.5 9.375Z"
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-block mb-16">
                                            <input type="email" name="email" id="e-mail"
                                                   class="form-control form-control-2 bg-white" required placeholder="Email Address">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20"
                                                 fill="none">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-block mb-16">
                                            <input type="tel" name="phone" id="phoneNumber"
                                                   class="form-control form-control-2 bg-white" required placeholder="Phone Number">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                                                 fill="none">
                                                <path
                                    ...
                                    <div class="col-md-12">
                                        <div class="input-block mb-16">
                                            <input type="text" name="address" id="location"
                                                   class="form-control form-control-2 bg-white"
                                                   required placeholder="Your Address House or Street Name">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                                                 fill="none">
                                                <path
                                    ...
                                    <div class="col-md-12">
                                        <div class="input-block mb-16">
                                            <input type="text" name="apartment" id="apartMent"
                                                   class="form-control form-control-2 bg-white"
                                                   required placeholder="Apartment, Suite, Unit, ect. (optional)">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                                                 fill="none">
                                                <path
                                                    d="M9.51246 19.7391C9.62113 19.9021 9.8041 20 10 20C10.1959 20 10.3789 19.9021 10.4875 19.7391C11.8742 17.6591 13.9167 15.0903 15.34 12.4778C16.478 10.3889 17.0312 8.60727 17.0312 7.03125C17.0312 3.15422 13.877 0 10 0C6.12297 0 2.96875 3.15422 2.96875 7.03125C2.96875 8.60727 3.52199 10.3889 4.66004 12.4778C6.08227 15.0883 8.12863 17.6634 9.51246 19.7391ZM10 1.17188C13.2309 1.17188 15.8594 3.80039 15.8594 7.03125C15.8594 8.40641 15.3529 10.0046 14.3109 11.9171C13.0841 14.1691 11.3334 16.4534 10 18.3738C8.66684 16.4537 6.91602 14.1692 5.6891 11.9171C4.64715 10.0046 4.14062 8.40641 4.14062 7.03125C4.14062 3.80039 6.76914 1.17188 10 1.17188Z"
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-block mb-16">
                                            <input type="text" name="town" id="city"
                                                   class="form-control form-control-2 bg-white" required placeholder="Town / City">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                                                 fill="none">
                                                <path
                                                    d="M9.51246 19.7391C9.62113 19.9021 9.8041 20 10 20C10.1959 20 10.3789 19.9021 10.4875 19.7391C11.8742 17.6591 13.9167 15.0903 15.34 12.4778C16.478 10.3889 17.0312 8.60727 17.0312 7.03125C17.0312 3.15422 13.877 0 10 0C6.12297 0 2.96875 3.15422 2.96875 7.03125C2.96875 8.60727 3.52199 10.3889 4.66004 12.4778C6.08227 15.0883 8.12863 17.6634 9.51246 19.7391ZM10 1.17188C13.2309 1.17188 15.8594 3.80039 15.8594 7.03125C15.8594 8.40641 15.3529 10.0046 14.3109 11.9171C13.0841 14.1691 11.3334 16.4534 10 18.3738C8.66684 16.4537 6.91602 14.1692 5.6891 11.9171C4.64715 10.0046 4.14062 8.40641 4.14062 7.03125C4.14062 3.80039 6.76914 1.17188 10 1.17188Z"
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-block mb-16">
                                            <input type="text" name="country" id="region"
                                                   class="form-control form-control-2 bg-white" required placeholder="Country / Region">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                                                 fill="none">
                                                <path
                                                    d="M9.51246 19.7391C9.62113 19.9021 9.8041 20 10 20C10.1959 20 10.3789 19.9021 10.4875 19.7391C11.8742 17.6591 13.9167 15.0903 15.34 12.4778C16.478 10.3889 17.0312 8.60727 17.0312 7.03125C17.0312 3.15422 13.877 0 10 0C6.12297 0 2.96875 3.15422 2.96875 7.03125C2.96875 8.60727 3.52199 10.3889 4.66004 12.4778C6.08227 15.0883 8.12863 17.6634 9.51246 19.7391ZM10 1.17188C13.2309 1.17188 15.8594 3.80039 15.8594 7.03125C15.8594 8.40641 15.3529 10.0046 14.3109 11.9171C13.0841 14.1691 11.3334 16.4534 10 18.3738C8.66684 16.4537 6.91602 14.1692 5.6891 11.9171C4.64715 10.0046 4.14062 8.40641 4.14062 7.03125C4.14062 3.80039 6.76914 1.17188 10 1.17188Z"
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-block mb-16">
                                            <input type="text" name="state" id="states"
                                                   class="form-control form-control-2 bg-white" required placeholder="State">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                                                 fill="none">
                                                <path
                                                    d="M9.51246 19.7391C9.62113 19.9021 9.8041 20 10 20C10.1959 20 10.3789 19.9021 10.4875 19.7391C11.8742 17.6591 13.9167 15.0903 15.34 12.4778C16.478 10.3889 17.0312 8.60727 17.0312 7.03125C17.0312 3.15422 13.877 0 10 0C6.12297 0 2.96875 3.15422 2.96875 7.03125C2.96875 8.60727 3.52199 10.3889 4.66004 12.4778C6.08227 15.0883 8.12863 17.6634 9.51246 19.7391ZM10 1.17188C13.2309 1.17188 15.8594 3.80039 15.8594 7.03125C15.8594 8.40641 15.3529 10.0046 14.3109 11.9171C13.0841 14.1691 11.3334 16.4534 10 18.3738C8.66684 16.4537 6.91602 14.1692 5.6891 11.9171C4.64715 10.0046 4.14062 8.40641 4.14062 7.03125C4.14062 3.80039 6.76914 1.17188 10 1.17188Z"
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-block mb-16">
                                            <input type="text" name="postal" id="zip"
                                                   class="form-control form-control-2 bg-white" required placeholder="Postcode / Zip">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                                                 fill="none">
                                                <path
                                                    d="M9.51246 19.7391C9.62113 19.9021 9.8041 20 10 20C10.1959 20 10.3789 19.9021 10.4875 19.7391C11.8742 17.6591 13.9167 15.0903 15.34 12.4778C16.478 10.3889 17.0312 8.60727 17.0312 7.03125C17.0312 3.15422 13.877 0 10 0C6.12297 0 2.96875 3.15422 2.96875 7.03125C2.96875 8.60727 3.52199 10.3889 4.66004 12.4778C6.08227 15.0883 8.12863 17.6634 9.51246 19.7391ZM10 1.17188C13.2309 1.17188 15.8594 3.80039 15.8594 7.03125C15.8594 8.40641 15.3529 10.0046 14.3109 11.9171C13.0841 14.1691 11.3334 16.4534 10 18.3738C8.66684 16.4537 6.91602 14.1692 5.6891 11.9171C4.64715 10.0046 4.14062 8.40641 4.14062 7.03125C4.14062 3.80039 6.76914 1.17188 10 1.17188Z"
                                ...
                                <div class="cus-checkBox ship-address">
                                    <input type="checkbox" id="shipAddress">
                                    <label for="shipAddress" class="fw-500">Ship to a different address?</label>
                                </div>
                                <div class="billing-address br-10 mt-24 mb-">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="input-block mb-16">
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-block mb-16">
                                                <input type="text" name="lname2" id="lastName2"
                                                       class="form-control form-control-2 bg-white" required placeholder="Last Name">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20"
                                                     viewBox="0 0 21 20" fill="none">
                                                    <path
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-block mb-16">
                                                <input type="email" name="email2" id="e-mail2"
                                                       class="form-control form-control-2 bg-white" required placeholder="Email Address">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20"
                                                     viewBox="0 0 21 20" fill="none">
                                                    <g clip-path="url(#clip0_7968_53870)">
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-block mb-16">
                                                <input type="tel" name="phone2" id="phoneNumber2"
                                                       class="form-control form-control-2 bg-white" required placeholder="Phone Number">
                                        ...
                                        <div class="col-md-12">
                                            <div class="input-block mb-16">
                                                <input type="text" name="address2" id="location2"
                                                       class="form-control form-control-2 bg-white"
                                                       required placeholder="Your Address House or Street Name">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                     viewBox="0 0 20 20" fill="none">
                                        ...
                                        <div class="col-md-12">
                                            <div class="input-block mb-16">
                                                <input type="text" name="apartment2" id="apartMent2"
                                                       class="form-control form-control-2 bg-white"
                                                       required placeholder="Apartment, Suite, Unit, ect. (optional)">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                     viewBox="0 0 20 20" fill="none">
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-block mb-16">
                                                <input type="text" name="town2" id="city2"
                                                       class="form-control form-control-2 bg-white" required placeholder="Town / City">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                     viewBox="0 0 20 20" fill="none">
                                                    <path
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-block mb-16">
                                                <input type="text" name="country2" id="region2"
                                                       class="form-control form-control-2 bg-white" required placeholder="Country / Region">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                     viewBox="0 0 20 20" fill="none">
                                                    <path
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-block mb-sm-0 mb-16">
                                                <input type="text" name="state2" id="states2"
                                                       class="form-control form-control-2 bg-white" required placeholder="State">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                     viewBox="0 0 20 20" fill="none">
                                                    <path
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-block">
                                                <input type="text" name="postal2" id="zip2"
                                                       class="form-control form-control-2 bg-white" required placeholder="Postcode / Zip">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                     viewBox="0 0 20 20" fill="none">
                                                    <path
                                ...
                                <!-- Payment Method -->
                                <div class="title-row title-row-2 mb-24 mt-32">
                                    <h5 class="fw-700 medium-black">Payment Methods</h5>
                                </div>
                                <div class="shipping-radio-container mb-32">
                                    <div class="plans mb-16">
                                        <label class="plan basic-plan" for="credit">
                                            ...
                                            <span class="plan-content content-2">
                                                    <span class="img-box">
                                                        <img src="{{asset('frontend/assets/media/icons/payment-card-1.png')}}" alt="">
                                                    </span>
                                                    <span class="plan-details">
                                                        <span class="fw-500 black">Credit or Debit Card</span>
                                                    </span>
                                                </span>
                                        </label>
                                    </div>
                                    <div class="plans mb-16">
                                        <label class="plan basic-plan" for="paypal">
                                            ...
                                            <span class="plan-content content-2">
                                                    <span class="img-box">
                                                        <img src="{{asset('frontend/assets/media/icons/payment-card-2.png')}}" alt="">
                                                    </span>
                                                    <span class="plan-details">
                                                        <span class="fw-500 black">Paypal</span>
                                                    </span>
                                                </span>
                                        </label>
                                    </div>
                                    <div class="plans mb-40">
                                        <label class="plan basic-plan" for="bank">
                                            ...
                                            <span class="plan-content content-2">
                                                    <span class="img-box">
                                                        <img src="{{asset('frontend/assets/media/icons/payment-card-3.png')}}" alt="">
                                                    </span>
                                                    <span class="plan-details">
                                                        <span class="fw-500 black">Direct Bank Transfer </span>
                                                    </span>
                                                </span>
                                        </label>
                                    </div>
                                ...
                                <div class="title-row title-row-2 mb-24 mt-32">
                                    <h5 class="fw-700 medium-black">Payment Details</h5>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="input-block mb-16">
                                            <input type="number" name="name" id="name01"
                                                   class="form-control form-control-2 bg-white" required placeholder="First Name">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20"
                                                 fill="none">
                                                <path
                                    ...
                                    <div class="col-md-12">
                                        <div class="input-block mb-16">
                                            <input type="text" name="lstName" id="nameLast"
                                                   class="form-control form-control-2 bg-white" required placeholder="Last Name">
                                    ...
                                    <div class="col-md-12">
                                        <div class="input-block mb-16">
                                            <input type="text" name="date" id="checkIn"
                                                   class="form-control form-control-2 bg-white sel-input date_from"
                                    ...
                                    <div class="col-md-12">
                                        <div class="input-block mb-16">
                                            <input type="number" name="cvv" id="cvvCode"
                                                   class="form-control form-control-2 bg-white" required placeholder="CVV Code">
                                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                                 xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                ...
                                <div class="d-flex align-items-center gap-8">
                                    ...
                                    <p class="medium-gray">Your Transaction is Secured with SSL Encryption</p>
                                </div>
                                <!-- Payment Method -->
                            </div>
                        </div>
                        <div class="col-xl-4">
                            <div class="bg-lightest-gray p-24 br-12">
                                <div class="title-row d-flex align-items-center justify-content-between mb-24">
                                    <h5 class="fw-700 medium-black">Product</h5>
                                    <h5 class="fw-700 medium-black">Amount</h5>
                                </div>
                                <div class="hr-line line-2 mb-24"></div>
                                <div class="summary-container mb-24">
                                    <div class="item-container mb-16">
                                        <div class="left-box d-flex align-items-center gap-24">
                                            <div class="icon-box">
                                                <img src="{{asset('frontend/assets/media/products/shop-sidebar-1.png')}}" alt="" class="br-8">
                                            </div>
                                            <a href="product-detail.html" class="h6 fw-700">Puppy Day Care</a>
                                        </div>
                                        <div class="right-box">
                                            <h6 class="medium-black fw-700">$80.00</h6>
                                        </div>
                                    </div>
                                    <div class="hr-line line-2 mb-16"></div>
                                    <div class="item-container mb-24">
                                        <div class="left-box d-flex align-items-center gap-24">
                                            <div class="icon-box">
                                                <img src="{{asset('frontend/assets/media/products/shop-sidebar-2.png')}}" alt="" class="br-8">
                                            </div>
                                            <a href="product-detail.html" class="h6 fw-700">Puppy Grooming</a>
                                        </div>
                                        <div class="right-box">
                                            <h6 class="medium-black fw-700">$25.00</h6>
                                        </div>
                                    </div>
                                    <div class="hr-line line-2 mb-24"></div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-24">
                                        <h6 class="fw-700 medium-black">Subtotal</h6>
                                        <h6 class="dark-gray fw-500">$105.00</h6>
                                    </div>
                                    <div class="hr-line line-2 mb-24"></div>
                                    <p class="mb-24">
                                        Your personal data will be used to process your order, support your experience
                                        throughout this website, and for other
                                        purposes described in our <span class="color-sec"> privacy policy.</span>
                                    </p>
                                    <div class="col-md-12">
