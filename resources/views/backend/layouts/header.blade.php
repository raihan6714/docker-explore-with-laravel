...
{{--                    </ul>--}}
            ...
            {{--                                   href="#">--}}
            {{--                                    <img src="{{ asset("backend/assets/images/brands/github.png") }}" class="mb-2 mx-auto h-6" alt="Github">--}}
            {{--                                    <span>GitHub</span>--}}
            {{--                                </a>--}}
            {{--                                <a class="dropdown-item hover:bg-gray-50/50 py-4 text-center dark:hover:bg-zinc-700/50 dark:hover:text-gray-50"--}}
            {{--                                   href="#">--}}
            {{--                                    <img src="{{ asset("backend/assets/images/brands/bitbucket.png") }}" class="mb-2 mx-auto h-6" alt="Github">--}}
            {{--                                    <span>Bitbucket</span>--}}
            {{--                                </a>--}}
            {{--                                <a class="dropdown-item hover:bg-gray-50/50 py-4 text-center dark:hover:bg-zinc-700/50 dark:hover:text-gray-50"--}}
            {{--                                   href="#">--}}
            {{--                                    <img src="{{ asset("backend/assets/images/brands/dribbble.png") }}" class="mb-2 mx-auto h-6" alt="Github">--}}
            {{--                                    <span>Dribbble</span>--}}
            {{--                                </a>--}}
            {{--                            </div>--}}
            {{--                            <div class="grid grid-cols-3">--}}
            {{--                                <a class="dropdown-item hover:bg-gray-50/50 py-4 text-center dark:hover:bg-zinc-700/50 dark:hover:text-gray-50"--}}
            {{--                                   href="#">--}}
            {{--                                    <img src="{{ asset("backend/assets/images/brands/dropbox.png") }}" class="mb-2 mx-auto h-6" alt="Github">--}}
            {{--                                    <span>Dropbox</span>--}}
            {{--                                </a>--}}
            {{--                                <a class="dropdown-item hover:bg-gray-50/50 py-4 text-center dark:hover:bg-zinc-700/50 dark:hover:text-gray-50"--}}
            {{--                                   href="#">--}}
            {{--                                    <img src="{{ asset("backend/assets/images/brands/mail_chimp.png") }}" class="mb-2 mx-auto h-6"--}}
            {{--                                         alt="Github">--}}
            {{--                                    <span>Mail Chimp</span>--}}
            {{--                                </a>--}}
            {{--                                <a class="dropdown-item hover:bg-gray-50/50 py-4 text-center dark:hover:bg-zinc-700/50 dark:hover:text-gray-50"--}}
            {{--                                   href="#">--}}
            {{--                                    <img src="{{ asset("backend/assets/images/brands/slack.png") }}" class="mb-2 mx-auto h-6" alt="Github">--}}
            {{--                                    <span>Slack</span>--}}
            {{--                                </a>--}}
            {{--                            </div>--}}
            ...
            {{--                                                <img src="{{ asset("backend/assets/images/users/avatar-3.jpg") }}" class="rounded-full h-8 w-8"--}}
            {{--                                                     alt="user-pic">--}}
            {{--                                            </div>--}}
            {{--                                            <div class="flex-grow">--}}
            ...
            {{--                                                        English.</p>--}}
            {{--                                                    <p class="mb-0"><i--}}
            {{--                                                            class="mdi mdi-clock-outline dark:text-gray-400"></i> <span>1 hour ago</span>--}}
            {{--                                                    </p>--}}
            {{--                                                </div>--}}
            {{--                                            </div>--}}
            {{--                                        </div>--}}
            ...
            {{--                                                        grammar</p>--}}
            {{--                                                    <p class="mb-0"><i--}}
            {{--                                                            class="mdi mdi-clock-outline dark:text-gray-400"></i> <span>3 min ago</span>--}}
            {{--                                                    </p>--}}
            {{--                                                </div>--}}
            {{--                                            </div>--}}
            {{--                                        </div>--}}
            ...
            {{--                                        <div class="flex px-4 py-2 hover:bg-gray-50/50 dark:hover:bg-zinc-700/50">--}}
            {{--                                            <div class="flex-shrink-0 ltr:mr-3 rtl:ml-3">--}}
            {{--                                                <img src="{{ asset("backend/assets/images/users/avatar-6.jpg") }}" class="rounded-full h-8 w-8"--}}
            {{--                                                     alt="user-pic">--}}
            {{--                                            </div>--}}
            {{--                                            <div class="flex-grow">--}}
